...
const About = () => {
  return (
    <div>
      ...
      <div className="bg-gray-50 py-10 px-4 sm:px-6 lg:px-24 min-h-screen">
        <div className="max-w-5xl mx-auto bg-white p-6 sm:p-10 rounded-xl shadow-lg">
          ...
          <p className="text-base sm:text-lg text-gray-700 mb-6 leading-relaxed text-justify">
            Welcome to{" "}
            <span className="font-semibold text-green-600">Refabry</span>, where
            innovation meets craftsmanship. Our mission is to deliver
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full table-auto border border-gray-200 text-sm sm:text-base text-gray-700">
              <thead className="bg-orange-500 text-white">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-left">Feature</th>
                  <th className="px-4 sm:px-6 py-3 text-left">Description</th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-gray-100 transition">
                  <td className="px-4 sm:px-6 py-4 font-medium">Experience</td>
          ...
          <div className="mt-8 sm:mt-10 text-gray-700">
            <p>
              At{" "}
